            ...
            <div class="specialty__content">
                ...
                <div class="gallery">
                    <div class="gallery__item">
                        <img src="./public/icon/chef gear hat 1.svg" alt="best chef" class="icon">
                        <p class="gallery__item--title">Koki Terbaik</p>
                    </div>

                    <div class="gallery__item">
                        <img src="./public/icon/house chimney 1.svg" alt="convinient place" class="icon">
                        <p class="gallery__item--title" tabindex="0">Tempat Yang Nyaman</p>
                    </div>

                    <div class="gallery__item">
                        <img src="./public/icon/vegetables broccoli.svg" alt="organic food" class="icon">
